  ...
  return (
    <div className="conditions-box">
      ...
      <ul className="conditions-list">
        <li>Время заезда: после 14:00. Время выезда: до 12:00.</li>
        ...
        <li>Проживание с домашними питомцами допускается только по предварительному согласованию с администрацией.</li>
      </ul>
    </div>
  );
};
